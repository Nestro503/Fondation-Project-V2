    ...
    for i in range(0, h, QUAD_RES):
        ...
        for j in range(0, w, QUAD_RES):
            ...
            if (i < 150 * mm_nbr_pixel_y and j < 150 * mm_nbr_pixel_x) or \
                    (i < 150 * mm_nbr_pixel_y and j > w - 150 * mm_nbr_pixel_x) or \
                    (i > h - 200 * mm_nbr_pixel_y and j < 150 * mm_nbr_pixel_x) or \
                    (i > h - 200 * mm_nbr_pixel_y and j > w - 150 * mm_nbr_pixel_x):
...
while True:
    ...
    img_with_grid, cases = process_grid(img_recadre, mm_nbr_pixel_x, mm_nbr_pixel_y, aruco_corners,
                                        mask_blanc, mask_cyan, mask_rouge, mask_gris)



    # Extraction et affichage des coordonnées des cubes par couleur
    cubes_blanc = [case.position for row in cases for case in row if case.categorie == 'cube' and case.couleur == 'blanc']
    cubes_cyan = [case.position for row in cases for case in row if case.categorie == 'cube' and case.couleur == 'cyan']
    cubes_rouge = [case.position for row in cases for case in row if case.categorie == 'cube' and case.couleur == 'rouge']
    cubes_gris = [case.position for row in cases for case in row if case.categorie == 'obstacle']

    # Check coord des cases pour vérif ensuite
    #print("Coordonnées des cubes blanc :", cubes_blanc)
    #print("Coordonnées des cubes cyan :", cubes_cyan)
    #print("Coordonnées des cubes rouges :", cubes_rouge)
    #print("Coordonnées des cubes gris :", cubes_gris)
    ...
    for centres_gris in unique_representatives_gris:
        ...
        # Affichage de l'image quadrillée
